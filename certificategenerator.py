...
template_path = '/root/certificate_generator/"Edit Your Template".png'
details_path = '/root/certificate_generator/details.xlsx'
output_path = '/root/certificate_generator/certificates/'
